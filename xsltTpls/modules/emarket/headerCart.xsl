...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:umi="http://www.umi-cms.ru/TR/umi">
	...
	<xsl:template name="header_basket">
		<div class="header_basket" id="header_basket">
			<xsl:apply-templates select="document('udata://emarket/cart/')/udata/summary" mode="header_basket"/>
		</div>
	</xsl:template>

	<!--Полная корзина товаров-->
	<xsl:template match="summary[amount != 0]" mode="header_basket">
	...
	<xsl:template match="summary" mode="header_basket">
