...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:umi="http://www.umi-cms.ru/TR/umi">
	...
	<xsl:template match="udata[@module = 'news'][@method = 'lastlist']">
		...
		<div class="news test4" umi:element-id="{$id}" umi:add-text="&add-text-news;" umi:module="news" umi:method="lastlist" umi:region="list" umi:type-id="{$newsItemPageTypeId}" umi:button-position="top right">
			...
			<xsl:apply-templates select="items/item" mode="item_news_s1"/>
		</div>
	...
	<!--Элемент списка новостей (ДЛЯ news_index_s1) -->
	<xsl:template match="udata[@method = 'lastlist']/items/item" mode="item_news_s1">
		...
		<div class="news_item test5" umi:region="row" umi:element-id="{@id}" umi:delete-text="&delete-text-news;" umi:delete="delete">
			<div class="news_title">
				<div class="top_date news_date" umi:field-name="publish_time" umi:field-type="date" umi:empty="&empty-page-date;">
